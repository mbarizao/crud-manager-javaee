        ...
        <tbody>
          <c:forEach var="usuario" items="${usuarios}">
            <tr>
              ...
              <td>${usuario.email}</td>
              <td>
	            <a href="/manager/ServletUsuario?action=edit&id=${usuario.id}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
	            <a href="/manager/ServletUsuario?action=delete&id=${usuario.id}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
	          </td>
            </tr>
          </c:forEach>
        </tbody>
